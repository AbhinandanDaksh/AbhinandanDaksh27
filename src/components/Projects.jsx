...
const Projects = () => {
  return (
    <div name="Projects" className="h-auto bg-[var(--bg-primary)] flex items-center transition-colors duration-300 justify-center px-4 md:px-[10%] pb-20 pt-10 md:pb-20 lg:pb-28 xl:pb-36">
                ...
                <div className="flex relative lg:text-right text-center bg-[var(--bg-secondary)] lg:bg-transparent opacity-95 lg:opacity-100 mt-12">
                  <div className="flex flex-col px-6 lg:px-0">
                    ...
                    <div className="text-[var(--text-muted)] gap-4 flex lg:justify-end justify-center items-center mt-4 mb-2">
                      ...
                      <a href="https://github.com/AbhinandanDaksh" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--accent)] text-xl transition-colors"><FaExternalLinkAlt /></a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="flex relative lg:text-left text-center bg-[var(--bg-secondary)] lg:bg-transparent opacity-95 lg:opacity-100 mt-12">
                  <div className="flex flex-col px-6 lg:px-0">
                    ...
                    <div className="h-auto bg-[var(--bg-secondary)] mt-6 shadow-md lg:shadow-[#020d1eb2]">
                      <p className='text-[var(--text-muted)] p-6 '>
                        <span className='text-[var(--accent)]'>Connectify</span> is a modern communication platform built with the <span className='text-[var(--accent)]'>MERN stack</span>, offering seamless messaging, real-time and notifications. With intuitive navigation and secure data handling, it enhances connectivity and delivers a smooth user experience.
                      </p>
                    </div>
                    ...
                    <div className="text-[var(--text-muted)] gap-4 flex lg:justify-start justify-center items-center mt-4 mb-2">
                      <a href="https://github.com/AbhinandanDaksh/Connectify" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--accent)] text-[22px] transition-colors"><FiGithub /></a>
                      <a href="https://connectify-xi-plum.vercel.app/login" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--accent)] text-xl transition-colors"><FaExternalLinkAlt /></a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="flex relative lg:text-right text-center bg-[var(--bg-secondary)] lg:bg-transparent opacity-95 lg:opacity-100 mt-12">
                  <div className="flex flex-col px-6 lg:px-0">
                    ...
                    <div className="h-auto bg-[var(--bg-secondary)] mt-6 shadow-md lg:shadow-[#020d1eb2]">
                      <p className='text-[var(--text-muted)] p-6 '> A responsive weather application built with ReactJS, offering real-time <span className='text-[var(--accent)]'>weather updates</span>, a <span className='text-[var(--accent)]'>5-day forecast</span>, and <span className='text-[var(--accent)]'>location-based</span> weather data. It features a toggle between <span className='text-[var(--accent)]'>Celsius</span> and <span className='text-[var(--accent)]'>Fahrenheit</span> and includes  </p>
                    ...
                    <div className="text-[var(--text-muted)] gap-4 flex lg:justify-end justify-center items-center mt-4 mb-2">
                      <a href="https://github.com/AbhinandanDaksh/Weather-App" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--accent)] text-[22px] transition-colors"><FiGithub /></a>
                      <a href="https://weather-app-eight-black-10.vercel.app/" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--accent)] text-xl transition-colors"><FaExternalLinkAlt /></a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="flex relative lg:text-left text-center bg-[var(--bg-secondary)] lg:bg-transparent opacity-95 lg:opacity-100 mt-12">
                  <div className="flex flex-col px-6 lg:px-0">
                    ...
                    <div className="h-auto bg-[var(--bg-secondary)] mt-6  shadow-md lg:shadow-[#020d1eb2]">
                      <p className='text-[var(--text-muted)] p-6'>
                        <span className='text-[var(--accent)]'>Jas Store</span> is an e-commerce platform built with <span className='text-[var(--accent)]'>HTML, CSS & JavaScript</span>, offering product listing, cart management, and responsive design. It features intuitive navigation, <span className='text-[var(--accent)]'>user-friendly</span> checkout flow, and a clean interface for online shopping.
                      </p>
                    ...
                    <div className="text-[var(--text-muted)] gap-4 flex lg:justify-start justify-center items-center mt-4 mb-2">
                      <a href="https://github.com/AbhinandanDaksh/JasStoreProject" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--accent)] text-[22px] transition-colors"><FiGithub /></a>
                      <a href="https://abhinandandaksh.github.io/JasStoreProject/" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--accent)] text-xl transition-colors"><FaExternalLinkAlt /></a>
                    </div>
                  </div>
                </div>
              </div>
